...
use WeatherStation\SDK\OpenWeatherMap\WeatherHistory;
...
class OWMApiClient
{
     ...
     *
     * @throws \Exception If $cache is neither false nor a valid callable extending owm\OpenWeatherMap\Util\Cache.
     * @api
     */
    ...
    private function cacheOrFetchResult($url)
    {
        if ($this->cacheClass !== false) {
            /** @var \WeatherStation\SDK\OpenWeatherMap\AbstractCache $cache */
