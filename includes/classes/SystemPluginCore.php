...
class Core {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_lws_query_lcd_measurements', $plugin_public, 'lws_query_lcd_measurements_callback');
		$this->loader->add_action( 'wp_ajax_nopriv_lws_query_lcd_measurements', $plugin_public, 'lws_query_lcd_measurements_callback');
		...
		$this->loader->add_action( 'wp_ajax_lws_query_justgage_measurements', $plugin_public, 'lws_query_justgage_measurements_callback' );
		$this->loader->add_action( 'wp_ajax_nopriv_lws_query_justgage_measurements', $plugin_public, 'lws_query_justgage_measurements_callback');
        ...
        $this->loader->add_action( 'wp_ajax_lws_query_radial_measurements', $plugin_public, 'lws_radial_data_callback');
        $this->loader->add_action( 'wp_ajax_nopriv_lws_query_radial_measurements', $plugin_public, 'lws_radial_data_callback');
        ...
        $this->loader->add_action( 'wp_ajax_lws_query_ltgraph_measurements', $plugin_public, 'lws_ltgraph_data_callback');
        $this->loader->add_action( 'wp_ajax_nopriv_lws_query_ltgraph_measurements', $plugin_public, 'lws_ltgraph_data_callback');
