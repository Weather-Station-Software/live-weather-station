...
class StamenHandling extends BaseHandling {
    ...
    public function output_feature() {
        ...
        $content .= $this->get_key_value_option_select('options-overlay', lws__('Overlay', 'live-weather-station'), $this->get_stamenmap_overlay_js_array(), true, $this->map_params['specific']['options']['overlay']);
        $content .= '</tbody></table>';
        return $content;
    }
