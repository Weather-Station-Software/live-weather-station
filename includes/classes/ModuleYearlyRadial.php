...
class Radial extends \WeatherStation\Engine\Module\Maintainer {
    ...
    protected function get_datasource() {
        ...
        $content .= $this->get_key_value_option_select('yearly-radial-measurements-period-type-'. $this->station_guid, __('Period type', 'live-weather-station'), $this->get_period_type_js_array(false, true, false, true), true, 'fixed-year');
        $content .= $this->get_neutral_option_select('yearly-radial-measurements-period-value-' . $this->station_guid, __('Period', 'live-weather-station'));
        $content .= $this->get_key_value_option_select('yearly-radial-measurements-values-'. $this->station_guid, __('Values', 'live-weather-station'), $this->get_radial_values_js_array(), true, 'temperature-rain-threshold');
    ...
    protected function get_parameters() {
        $content = '<table cellspacing="0" style="display:inline-block;"><tbody>';
        $content .= $this->get_key_value_option_select('yearly-radial-measurements-template-'. $this->station_guid, __('Template', 'live-weather-station'), $this->get_graph_template_js_array(), true, 'neutral');
        $content .= $this->get_key_value_option_select('yearly-radial-measurements-height-'. $this->station_guid, __('Height', 'live-weather-station'), $this->get_graph_size_js_array(false, true), true, '400px');
        $content .= $this->get_key_value_option_select('yearly-radial-measurements-valuescale-'. $this->station_guid, __('Value scale', 'live-weather-station'), $this->get_y_scale_js_array(true, false, true), true, 'auto');
        $content .= $this->get_key_value_option_select('yearly-radial-measurements-data-'. $this->station_guid, __('Data', 'live-weather-station'), $this->get_graph_data_js_array(false), true, 'inline');
        $content .= '</tbody></table>';
