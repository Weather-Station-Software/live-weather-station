...
class Lines extends \WeatherStation\Engine\Module\Maintainer {
    ...
    protected function get_parameters() {
        ...
        $content .= $this->get_key_value_option_select('daily-lines-datas-valuescale-'. $this->station_guid, __('Value scale', 'live-weather-station'), $this->get_y_scale_js_array(true), true, 'auto');
