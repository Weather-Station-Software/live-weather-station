...
class DoubleLine extends \WeatherStation\Engine\Module\Maintainer {
    ...
    public function __construct($station_information) {
        ...
        $this->module_hint = __('Display historical data as a bi-line chart. Allows to view, side by side on the same graph, two types of measurement having different physical dimensions.', 'live-weather-station');
    ...
    protected function get_parameters() {
        ...
        $content .= $this->get_key_value_option_select('yearly-doubleline-datas-valuescale-'. $this->station_guid, __('Value scale', 'live-weather-station'), $this->get_y_scale_js_array(true), true, 'auto', false, false);
