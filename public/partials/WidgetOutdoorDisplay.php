...
<div class="lws-widget-container-<?php echo $id ?>">
    <div class="lws-widget-outer-outdoor-<?php echo $id ?>">
        ...
        <?php if ($show_pressure):?>
            <!-- PRESSURE -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Atmospheric pressure', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <i class="wi wi-x26-<?php echo $id ?> wi-barometer"></i>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['pressure']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['pressure']['unit']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_uv):?>
            <!-- UV -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('UV', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <i class="wi wi-x26-<?php echo $id ?> wi-horizon-alt"></i>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['uv_index']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['uv_index']['unit']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_wind && $wind_multipart):?>
            <!-- WIND -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.__('Wind from', 'live-weather-station').' '.$datas['windangle']['from'].'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-big-value-<?php echo $id ?>"><?php echo $datas['windstrength']['value']; ?></div>
                    <div class="lws-widget-big-unit-<?php echo $id ?>"><?php echo $datas['windstrength']['unit']; ?></div>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-small-row-<?php echo $id ?>">
                        <div class="lws-widget-small-value-up-<?php echo $id ?>"><?php echo $datas['windstrength_max']['value']; ?></div>
                        <div class="lws-widget-small-unit-up-<?php echo $id ?>"><?php echo $datas['windstrength_max']['unit']; ?></div>
                    </div>
                    <div class="lws-widget-small-row-<?php echo $id ?>">
                        <div class="lws-widget-small-value-down-<?php echo $id ?>"><?php esc_html_e('max', 'live-weather-station'); ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_wind && !$wind_multipart):?>
            ...
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.__('Wind from', 'live-weather-station').' '.$datas['windangle']['from'].'"' : ''); ?>>
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['windstrength']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['windstrength']['unit']; ?></div>
                    </div>
                </div>
            </div>
            <?php if ($show_rain || $show_strike || $show_snow || $show_cloud_cover || $show_cloud_ceiling || $show_windchill || $show_humidex || $show_heat || $show_frost || $show_dew):?>
        ...
        <?php if ($show_rain && $rain_multipart):?>
            <!-- RAIN -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Rainfall', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-big-value-<?php echo $id ?>"><?php echo $datas['rain']['value']; ?></div>
                    <div class="lws-widget-big-unit-<?php echo $id ?>"><?php echo $datas['rain']['unit']; ?></div>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-small-row-<?php echo $id ?>">
                        <div class="lws-widget-small-value-up-<?php echo $id ?>"><?php echo $datas['rain_day_aggregated']['value']; ?></div>
                        <div class="lws-widget-small-unit-up-<?php echo $id ?>"><?php echo $datas['rain_day_aggregated']['unit']; ?></div>
                    </div>
                    <div class="lws-widget-small-row-<?php echo $id ?>">
                        <div class="lws-widget-small-value-down-<?php echo $id ?>"><?php esc_html_e('today', 'live-weather-station'); ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_rain && !$rain_multipart):?>
            ...
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Rainfall', 'live-weather-station').'"' : ''); ?>>
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['rain']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['rain']['unit']; ?></div>
                    </div>
                </div>
            </div>
            <?php if ($show_strike || $show_snow || $show_cloud_cover || $show_cloud_ceiling || $show_windchill || $show_humidex || $show_heat || $show_frost || $show_dew):?>
        ...
        <?php if ($show_strike):?>
            <!-- WIND -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Thunderstorm', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-big-value-<?php echo $id ?>"><?php echo $datas['strike']['value']; ?></div>
                    <div class="lws-widget-big-unit-<?php echo $id ?>"><?php echo $datas['strike']['unit']; ?></div>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-small-row-<?php echo $id ?>">
                        <div class="lws-widget-small-value-up-<?php echo $id ?>"><?php echo $datas['strike_distance']['value']; ?></div>
                        <div class="lws-widget-small-unit-up-<?php echo $id ?>"><?php echo $datas['strike_distance']['unit']; ?></div>
                    </div>
                    <div class="lws-widget-small-row-<?php echo $id ?>">
                        <div class="lws-widget-small-value-down-<?php echo $id ?>"><?php echo $datas['strike_distance']['ts']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_snow):?>
            <!-- RAIN -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Snowfall', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <i class="wi wi-x26-<?php echo $id ?> wi-snowflake-cold"></i>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['snow']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['snow']['unit']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_cloud_cover):?>
            <!-- CLOUDINESS -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Cloudiness', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <i class="wi wi-x26-<?php echo $id ?> wi-cloud"></i>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['cloudcover']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['cloudcover']['unit']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_cloud_ceiling):?>
            <!-- CLOUD BASE -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Cloud base altitude', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <i class="wi wi-x26-<?php echo $id ?> wi-cloud-up"></i>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['cloudceiling']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['cloudceiling']['unit']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_dew):?>
            <!-- DEW POINT -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Dew point', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <i class="wi wi-x26-<?php echo $id ?> wi-raindrops"></i>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['dew']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['dew']['unit']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_frost):?>
            <!-- FROST POINT -->
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Frost point', 'live-weather-station').'"' : ''); ?>>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <i class="wi wi-x26-<?php echo $id ?> wi-stars"></i>
                </div>
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['frost']['value']; ?></div>
                        <div class="lws-widget-med-unit-<?php echo $id ?>"><?php echo $datas['frost']['unit']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_heat):?>
            ...
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Heat index', 'live-weather-station').'"' : ''); ?>>
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['heat']['value']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_humidex):?>
            ...
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Humidex', 'live-weather-station').'"' : ''); ?>>
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['humidex']['value']; ?></div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($show_windchill):?>
            ...
            <div class="lws-widget-row-<?php echo $id ?>"<?php echo ($show_tooltip ? ' title="'.esc_html__('Wind chill', 'live-weather-station').'"' : ''); ?>>
                ...
                <div class="lws-widget-column-<?php echo $id ?>">
                    <div class="lws-widget-column-<?php echo $id ?>">
                        <div class="lws-widget-med-value-<?php echo $id ?>"><?php echo $datas['windchill']['value']; ?></div>
                    </div>
                </div>
            </div>
        <?php endif;?>
