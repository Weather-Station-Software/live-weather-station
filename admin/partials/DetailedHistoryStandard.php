...
<div id="normal-sortables" class="meta-box-sortables ui-sortable">
    <div id="daily-histo" class="postbox ">
        ...
        <h3 class="hndle"><span><?php echo __('Data of the day', 'live-weather-station' );?></span></h3>
        <div class="inside">
            <?php if ((bool)get_option('live_weather_station_collect_history')) { ?>
            <p><strong><?php echo __('Depending on the capabilities of the collected stations, the data of the day - compiled at a frequency ranging from 5 to 15 minutes depending on the type of the station - are:', 'live-weather-station');?></strong></p>
