    ...
    <div id="referrers" class="postbox ">
        ...
        <div class="inside">
            <table cellspacing="10" width="99%">
                <tbody>
                <tr>
                    <td width="10%"/><td width="20px"><i style="color:#666666" class="fa fa-lg fa-window-maximize"></i></td>
                    <td><?php echo Env::webserver_software_name().' '.__('with', 'live-weather-station').' '.Env::webserver_api(); ?></td>
                </tr>
                <tr>
                    <td width="10%"/><td width="20px"><i style="color:#666666" class="fa fa-lg fa-bolt"></i></td>
                    <td><?php echo Env::webserver_protocol().' '.__('on port', 'live-weather-station').' '.Env::webserver_port(); ?></td>
                </tr>
                <tr>
                    <td width="10%"/><td width="20px"><i style="color:#666666" class="fa fa-lg fa-hdd-o"></i></td>
