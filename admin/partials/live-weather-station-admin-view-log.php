...
<div class="wrap">
    ...
    <p>
        ...
        <br />
        <textarea readonly cols="80" rows="6" style="font-family:Consolas,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New, monospace;" "><?php echo $log['message'];?></textarea>
    </p>
