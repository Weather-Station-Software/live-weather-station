...
$message .= InlineHelp::get(16, ' See %s for detailed information.',  __('documentation', 'live-weather-station'));

?>

<form action="<?php echo esc_url(get_admin_page_url('lws-station')); ?>" method="POST" style="margin:0px;padding:0px;">
    <input type="hidden" name="action" value="manage" />
    <input type="hidden" name="service" value="station" />
    <input type="hidden" name="tab" value="edit" />
    <input type="hidden" name="guid" value="<?php echo $station['guid']; ?>" />
    <?php wp_nonce_field('edit-station', '_wpnonce', true ); ?>
