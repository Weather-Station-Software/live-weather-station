    ...
    <div id="referrers" class="postbox ">
        ...
        <div class="inside">
            <table cellspacing="10" width="99%">
                <tbody>
                <tr>
                    <td width="10%"/><td width="20px"><i style="color:#666666" class="fa fa-lg fa-server"></i></td>
                    <td/><?php echo gethostname().' <code>'.Env::server_ip().'</code>'; ?></td>
                </tr>
                <tr>
                    <td width="10%"/><td width="20px"><i style="color:#666666" class="fa fa-lg fa-cog"></i></td>
                    <td><?php echo Env::server_os(); ?></td>
                </tr>
                <?php if (Env::server_cpu() && Env::server_core()) { ?>
                    <tr>
                        <td width="10%"/><td width="20px"><i style="color:#666666" class="fa fa-lg fa-microchip"></i></td>
                        <td><?php echo Env::server_cpu() . ' / ' . Env::server_core() . ' ' . __('cores', 'live-weather-station'); ?></td>
                    </tr>
                <?php } ?>
                <?php if (Env::server_full_information()) { ?>
                    <tr>
                        <td width="10%"/><td width="20px"><i style="color:#666666" class="fa fa-lg fa-map-marker"></i></td>
