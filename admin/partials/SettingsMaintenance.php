...
<p><a class="button button-primary" href="<?php echo esc_url(get_admin_page_url('lws-settings', 'reset-dashboard', 'maintenance')); ?>"><?php echo __('Reset Dashboard View', 'live-weather-station');?></a> &nbsp;&nbsp;&nbsp;
    ...
    <a class="button button-primary" href="<?php echo esc_url(get_admin_page_url('lws-settings', 'reset-analytics', 'maintenance')); ?>"><?php echo __('Reset Analytics Views', 'live-weather-station');?></a></p>
...
<p><a class="button button-primary" href="<?php echo esc_url(get_admin_page_url('lws-settings', 'reset-cache', 'maintenance')); ?>"><?php echo __('Invalidate Cache', 'live-weather-station');?></a> &nbsp;&nbsp;&nbsp;
    <a class="button button-primary" href="<?php echo esc_url(get_admin_page_url('lws-settings', 'purge-log', 'maintenance')); ?>" onclick="lws_purgelog_confirmation = confirm('<?php echo $cache_warning; ?>'); return lws_purgelog_confirmation;"><?php echo __('Purge Events Log', 'live-weather-station');?></a></p>